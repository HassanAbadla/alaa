...
export default {
  ...
  computed: {
    ...mapGetters({
      getStatuses: "bscInitiativeStatuses/getBscInitiativeStatuses",
      getCurrentStatus: "bscInitiativeStatuses/getCurrentStatus",
      loadingStatus: "bscInitiativeStatuses/isLoading"
    }),
    swatchStyle() {
      return {
  ...
  methods: {
    ...mapActions({
      addStatus: "bscInitiativeStatuses/addStatus",
      fetchStatuses: "bscInitiativeStatuses/fetchStatuses",
      updateStatus: "bscInitiativeStatuses/updateStatus",
      fetchStatusById: "bscInitiativeStatuses/fetchStatusById"
    }),
