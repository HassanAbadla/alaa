...
export default {
  ...
  computed: {
    ...mapGetters({
      ...
      getCurrentStatus: "rvpReviewStatuses/getCurrentStatus",
      loadingStatus: "rvpReviewStatuses/isLoading"
    }),
    swatchStyle() {
      return {
  ...
  methods: {
    ...mapActions({
      addStatus: "rvpReviewStatuses/addStatus",
      fetchStatuses: "rvpReviewStatuses/fetchStatuses",
      updateStatus: "rvpReviewStatuses/updateStatus",
      fetchStatusById: "rvpReviewStatuses/fetchStatusById"
    }),
