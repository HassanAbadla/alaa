...
export default {
  name: "ServicesContractsStatusesForm",
  props: {
    itemPath: {
      type: String,
      required: true
  ...
  computed: {
    ...mapGetters({
      getCurrentStatus: "srvContractStatuses/getCurrentStatus",
  ...
  methods: {
    ...mapActions({
      addStatus: "srvContractStatuses/addStatus",
      updateStatus: "srvContractStatuses/updateStatus",
      fetchStatusById: "srvContractStatuses/fetchStatusById"
    }),
