...
export default {
  ...
  computed: {
    ...mapGetters({
      getStatuses: "tprmStatuses/getBscTeamStatuses",
      getCurrentStatus: "tprmStatuses/getCurrentStatus",
      loadingStatus: "tprmStatuses/isLoading"
    }),
    swatchStyle() {
      return {
  ...
  methods: {
    ...mapActions({
      addStatus: "tprmStatuses/addStatus",
      fetchStatuses: "tprmStatuses/fetchStatuses",
      updateStatus: "tprmStatuses/updateStatus",
      fetchStatusById: "tprmStatuses/fetchStatusById"
    }),
