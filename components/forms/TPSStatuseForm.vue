...
export default {
  ...
  computed: {
    ...mapGetters({
      ...
      getCurrentStatus: "tpsStatuses/getCurrentStatus",
      loadingStatus: "tpsStatuses/isLoading"
    }),
    swatchStyle() {
      return {
  ...
  methods: {
    ...mapActions({
      addStatus: "tpsStatuses/addStatus",
      fetchStatuses: "tpsStatuses/fetchStatuses",
      updateStatus: "tpsStatuses/updateStatus",
      fetchStatusById: "tpsStatuses/fetchStatusById"
    }),
