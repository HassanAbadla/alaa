    ...
    <v-card flat class="pt-12">
      <v-card-text class="pt-0">
        <custom-table
          ...
          :propItems="criticalities"
          :propLoading="loadingCriticalities"
          hideView
          :sortOnLoad="false"
          hideHeaders
          :fullPageTable="false"
...
export default {
  ...
  data() {
    return {
      tableConfig: {
        delete: this.deleteCriticality,
        itemPath: "/criticalities",
        createForm: {
          componentPath: "forms/LookupForm",
          props: { itemPath: "criticalities", width: 500 }
        },
        editForm: {
          componentPath: "forms/LookupForm",
          props: { itemPath: "criticalities", editForm: true, width: 500 }
        },
        permissions: {
