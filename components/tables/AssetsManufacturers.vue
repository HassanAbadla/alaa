  ...
  <v-can show-message :permission="'create_policy'">
    <v-card flat class="pt-12">
      <v-card-text class="pt-0">
        <custom-table
          :title="$t('table.manufacturers')"
          :headers="headers"
          :tableConfig="tableConfig"
          :propItems="manufacturers"
          :propLoading="loadingManufacturers"
          hideView
          :sortOnLoad="false"
          hideHeaders
          :fullPageTable="false"
...
export default {
  ...
  data() {
    return {
      tableConfig: {
        delete: this.deleteManufacturer,
        itemPath: "/manufacturers",
        createForm: {
          componentPath: "forms/LookupForm1",
          props: { itemPath: "manufacturers", width: 500 }
        },
        editForm: {
          componentPath: "forms/LookupForm1",
          props: { itemPath: "manufacturers", editForm: true, width: 500 }
        },
        permissions: {
  ...
  methods: {
    ...mapActions("manufacturers", ["createManufacturer", "fetchManufacturers", "deleteManufacturer"]),
