    ...
    <v-card flat class="pt-12">
      <v-card-text class="pt-0">
        <custom-table
          ...
          :propItems="getDistricts"
          :propLoading="loadingDistricts"
          hideView
          :filters.sync="filters"
          @clear-filters="fetchDistricts"
          :sortOnLoad="false"
          hideHeaders
          :fullPageTable="false"
        >
...
export default {
  ...
  data() {
    return {
      ...
      // policies: [],
      tableConfig: {
        delete: this.deleteDistrict,
        itemPath: "/geo-districts",
        createForm: {
          componentPath: "forms/DistrictsForm",
          props: { width: 500 }
        },
        editForm: {
          componentPath: "forms/DistrictsForm",
