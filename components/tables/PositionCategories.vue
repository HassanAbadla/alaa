...
export default {
  ...
  data() {
    return {
      ...
      // policies: [],
      tableConfig: {
        delete: this.deletePositionCategory,
        itemPath: "/settings/position-categories",
        createForm: {
  ...
  methods: {
    ...mapActions("positionSettings", ["fetchPositionCategories", "deletePositionCategory"]),
  ...
  computed: {
    ...mapState("positionSettings", ["categories"])
  },
