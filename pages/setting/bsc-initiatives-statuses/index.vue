<template>
  <v-can show-message :permission="'view_initiatives_status'">
...
export default {
  ...
  data() {
    return {
      tableConfig: {
        ...
        itemPath: "/bsc-initiative-statuses",
        createForm: {
          componentPath: "forms/BSCInitiativeStatusForm",
        ...
        permissions: {
          create: "create_initiatives_status",
          edit: "edit_initiatives_status",
          delete: "delete_initiatives_status"
        }
      },
      headers: [
  ...
  methods: {
    ...mapActions({
      ...
      deleteStatus: "bscInitiativeStatuses/deleteStatus"
    }),
    async fetchTypes() {
