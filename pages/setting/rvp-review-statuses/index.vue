<template>
  <v-can show-message :permission="'view_rvp_status'">
...
export default {
  ...
  data() {
    return {
      tableConfig: {
        ...
        itemPath: "/rvp-review-statuses",
        createForm: {
          componentPath: "forms/RVPReviewStatuseForm",
        ...
        permissions: {
          create: "create_rvp_status",
          edit: "edit_rvp_status",
          delete: "delete_rvp_status"
        }
      },
      headers: [
  ...
  methods: {
    ...mapActions({
      fetchStatuses: "rvpReviewStatuses/fetchStatuses",
      deleteStatus: "rvpReviewStatuses/deleteStatus"
    }),
    async fetchTypes() {
  ...
  computed: {
    ...mapGetters({
      getStatuses: "rvpReviewStatuses/getStatuses",
      loadingStatuses: "rvpReviewStatuses/isLoading"
    })
  },
  mounted() {
    this.fetchTypes()
